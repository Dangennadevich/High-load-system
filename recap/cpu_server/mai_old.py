...
async def predict(text_input: TextInput):
    ...
    try:
        ...
        # Отправляем задачу в Celery через direct_exchange
        # celery_app.send_task(
        #     'process_task',
        #     args=[task_id, text_input.text],
        #     queue="tasks_pred_gen_txt"  # 👈 Используем кастомную очередь
        # )

        celery_app.send_task(
            # "process_task",  # 👈 Это просто название для маршрутизации
            args=[task_id, text_input.text],
